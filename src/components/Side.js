		...
		return (
			<div className={`side`}>
				<div className='side-outer side-header'>
					...
					<div className='outer-line'>{selSubPart && GetLangLabel(selSubPart, lan)}</div><div className='outer-price'>{priceTotal} EUR</div>
				</div>
